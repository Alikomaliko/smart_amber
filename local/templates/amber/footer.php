            ...
            <div class="container">
                <div class="row align-items-center m-b-n20">
                    ...
                    <div class="col-md-6 text-center text-md-end order-1 order-md-2 m-b-20">
                        <div class="payment">
                            <a href="#/">
                                <img class="fit-image" src="<?=SITE_TEMPLATE_PATH?>/assets/images/payment/payment_large.png" alt="Payment">
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="<?=SITE_TEMPLATE_PATH?>/assets/images/products/large-product/1.png" alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="<?=SITE_TEMPLATE_PATH?>/assets/images/products/large-product/2.png" alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="<?=SITE_TEMPLATE_PATH?>/assets/images/products/large-product/3.png" alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="<?=SITE_TEMPLATE_PATH?>/assets/images/products/large-product/4.png" alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100" src="<?=SITE_TEMPLATE_PATH?>/assets/images/products/large-product/5.png" alt="Product">
                                    </a>
                                </div>
                    ...
                    <div class="col-md-6 col-12 overflow-hidden position-relative">
                        ...
                        <div class="product-summery position-relative">
                            ...
                            <div class="payment-option m-t-20 d-flex justify-content-start">
                                ...
                                <a href="#">
                                    <img class="fit-image m-l-5" src="<?=SITE_TEMPLATE_PATH?>/assets/images/payment/payment_large.png" alt="Payment Option Image">
                                </a>
                            </div>
                            <!-- Payment Option End -->
